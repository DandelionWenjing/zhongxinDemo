...
public final class CreateSimpleInternetFacingLoadBalancer {
    ...
    public static boolean runSample(Azure azure) {
        final Region region = Region.CHINA_NORTH;
        final String resourceGroupName = "LoadBalancerGroup";
    ...
    public static void main(String[] args) {
        try {
            ...
            final File credFile = new File(System.getenv("AZURE_AUTH_LOCATION_MOONCAKE"));
